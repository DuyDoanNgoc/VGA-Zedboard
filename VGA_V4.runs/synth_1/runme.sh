...
HD_PWD='E:/Tai Lieu/2020.1/VIVADO/FILE/VGA_V4/VGA_V4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_RGB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_RGB.tcl
