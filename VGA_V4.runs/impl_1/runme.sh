...
HD_PWD='E:/Tai Lieu/2020.1/VIVADO/FILE/VGA_V4/VGA_V4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_RGB.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_RGB.tcl -notrace
